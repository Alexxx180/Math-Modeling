...
class RandomCalculus:
    ...
    def math_is_not_ready(self, math: float) -> None:
        assert(math == 0, "Expression is not calculated yet.")
    ...
    def dispersia_ground_end(self, n: int) -> None:
        self.math_is_not_ready(self.eval)
        n1: int = n - 1
        self.ground = (self.ground / n1) - (n / n1) * (self.eval ** 2)
